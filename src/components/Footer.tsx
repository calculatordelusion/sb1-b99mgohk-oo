      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            >
              <Cookie size={24} className="text-amber-200" />
              <span>Cookie Clicker Unblocked</span>
            </Link>
            <p className="text-amber-200 text-sm">
              The most addictive cookie clicker unblocked game you'll ever play!
              Click, upgrade, and become a cookie tycoon.
            </p>
          </div>
        ...
        <div className="mt-8 pt-6 border-t border-amber-800 text-center text-sm">
          <p className="flex items-center justify-center gap-1">
            Made with{' '}
            <Heart size={16} className="text-red-500" fill="currentColor" /> by
            Cookie Clicker Unblocked Team © {new Date().getFullYear()}
          </p>
